...
public class HowToUseDialog extends JDialog {
    ...
    private DefaultMutableTreeNode root = new DefaultMutableTreeNode("Aknakereső");
    ...
    private DefaultMutableTreeNode nodeLevels =
            new DefaultMutableTreeNode("Szintek, rekordok");
    ...
    /** Konstruktor */
    public HowToUseDialog(MineFrame mineFrame) {
        super(mineFrame, "Használat", true);
        try {
            jbInit();
//            pack();
        } catch (Exception ex) {
...
//        }
    ...
    private void jbInit() throws Exception {
        ...
        treeModel.insertNodeInto(nodeLevels, root, root.getChildCount());
